...
<div class="form-outline mb-4">
    <label class="form-label" for="authorsId">Select one or more authors</label>
    <select id="authorsId" name="authors[]" class="form-select" multiple="multiple" size="5" required>
    </select>
</div>
...
<script>
    ...
    loadSelect(urlAuthor, "#authorsId");
</script>
<?php $this->end() ?>